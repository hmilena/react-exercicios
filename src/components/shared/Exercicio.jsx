        ...
        {codigo && (
          <>
            <Accordion
              ...
              titleClass={`cursor-pointer w-full flex justify-between items-center p-2 text-slate-800 transition mb-4 rounded hover:bg-emerald-200 bg-emerald-100`}
              isOpenClass="bg-emerald-200"
              spanClass="px-4 font-bold"
            >
            ...
            <span className="mt-4 inline-flex items-center rounded-md bg-green-50 px-2 py-1 text-xs font-medium text-green-700 inset-ring inset-ring-green-600/20 mb-2">
              Resultado:
            </span>
